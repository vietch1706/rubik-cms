    ...
    <form method="POST" action="{{ route('brands.update', ['id' => $brand['id']]) }}" enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="col mb-3">
                ...
                <input type="text" class="form-control" id="slug" name="slug" readonly value="{{ $brand['slug'] }}">
                @error('slug')
        ...
        <div class="row">
            <div class="col-md-6 mb-3">
                ...
                <input type="datetime-local" class="form-control" value="{{ $brand['created_at'] }}" readonly>
            </div>
            <div class="col-md-6 mb-3">
                <label class="form-label">Updated At </label>
                <input type="datetime-local" class="form-control" value="{{ $brand['updated_at'] }}" readonly>
            </div>
        </div>
        ...
        <div class="d-grid gap-2 d-md-flex justify-content-md-between">
            ...
            <div class="right-item">
                <button class="delete-item" data-id="{{ $brand['id'] }}">
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            ...
                            success: function (response) {
                                Swal.fire({
                                    title: 'Deleted!',
                                    text: 'Your selected brand have been deleted.',
                                    icon: 'success'
                                }).then(function () {
