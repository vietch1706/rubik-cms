    ...
    <form method="POST" action="{{ route('categories.update', ['id' => $categories['id']]) }}"
        ...
        <div class="row">
            <div class="col-md-6 mb-3">
                ...
                <input type="datetime-local" class="form-control" value="{{ $categories['created_at'] }}" readonly>
            </div>
            <div class="col-md-6 mb-3">
                <label class="form-label">Updated At </label>
                <input type="datetime-local" class="form-control" value="{{ $categories['updated_at'] }}" readonly>
            </div>
        </div>
